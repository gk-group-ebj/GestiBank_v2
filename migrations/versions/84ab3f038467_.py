...
Revision ID: 84ab3f038467
Revises: 
Create Date: 2019-10-14 01:31:25.190954
...
def upgrade():
    ...
    sa.Column('id_card', sa.String(length=128), nullable=True),
    sa.Column('proof_of_address', sa.String(length=128), nullable=True),
